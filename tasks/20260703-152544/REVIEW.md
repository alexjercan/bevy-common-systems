...
Reviewed the docs commit: `tasks/20260703-152544/NOTES.md`
...
- [ ] R1.1 (MINOR) AGENTS.md:230 - the `06_fruitninja` bullet says "see
  ...
  actually committed as `tasks/20260703-152544/NOTES.md` (the
  ...
  - Response: fixed - AGENTS.md now points at
    `tasks/20260703-152544/NOTES.md`. Grepped the tree: no
...
`tasks/20260703-152544/NOTES.md`, which exists on disk. No
