...
phone in the wasm showcase. See `tasks/20260704-142016/NOTES.md` and
`tasks/20260704-130314/NOTES.md` for what shipped. This is about how
the working went.
...
- **First pass implemented the literal steps and missed the goal's implication.**
  ...
  (`tasks/20260704-103517/RETRO.md`): the enumerated
