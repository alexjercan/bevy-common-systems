...
(`docs/spikes/20260704-134035-game-juice-and-scaffolding-kit.md` -- shake,
popup, flash, tween, persist, spawner, menu) and the input/projection harvest
(`docs/spikes/20260704-161210-input-and-projection-harvest.md` -- pointer,
...
plus unnamed ones -- across `docs/retros/20260703-213510-dropzone-tune.md`,
`docs/2026-07-04-dropzone-tier-a-fun.md`, `tasks/20260704-103544`,
`tasks/20260704-103553`, `tasks/20260704-103517`,
`docs/2026-07-04-reactor-example.md`, `tasks/20260704-130314`,
...
(`docs/retros/20260704-143000-reactor-overload-mobile-touch.md`). The screenshot
